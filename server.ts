...
if (process.env.NODE_ENV === 'production') {
      const corsOptions = {
            origin: ['https://findyourland-1941204b7c9e.herokuapp.com', 'http://findyourland-1941204b7c9e.herokuapp.com'],
            credentials: true
      }
...
import { router as artistRoutes } from './api/artist/artist.routes'
